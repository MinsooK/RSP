...
int geometry()
{
    std::cout << test::time << std::endl;
    KDL::Vector v1;
    KDL::Vector v2 = KDL::Vector::Zero();

    std::cout<<"v1: "<<v1[0]<<", "<<v1[1]<<", "<<v1[2]<<std::endl;

    std::cout<<"dot(v1,v2) = "<<dot(v1,v2)<<std::endl;
//    double dot_num = dot(v1,v2);
//    std::cout << "dot(v1,v2) = " << dot_num << std::endl; 
//    KDL::Rotation r1=KDL::Rotation::EulerZYX(1.,2.,3.);
//    KDL::Rotation r2(0,0,-1,1,0,0,0,-1,0);
